...
from ..utils.nlp import extract_years_experience_spacy, extract_graduation_year_spacy
...
def extract_graduation_year(resume_text: str) -> int:
    # Use the original implementation (spaCy version removed for reliability)
    text = resume_text.lower()
